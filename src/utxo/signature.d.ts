 ...
 */
export declare function getSignatureVerifications(transaction: UtxoTransaction, inputIndex: number, amount: number, verificationSettings?: VerificationSettings, _prevOutputs?: TxOutput[]): SignatureVerification[];
/**
...
export declare function signInput2Of3(txBuilder: UtxoTransactionBuilder, vin: number, scriptType: ScriptType2Of3, pubkeys: Triple<Buffer>, keyPair: bip32.BIP32Interface, _cosigner: Buffer, amount: number): void;
export {};
