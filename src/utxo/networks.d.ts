declare type NetworkName = 'bitcoin' | 'testnet' | 'bitcoincash' | 'bitcoincashTestnet' | 'bitcoingold' | 'bitcoingoldTestnet' | 'bitcoinsv' | 'bitcoinsvTestnet' | 'dash' | 'dashTest' | 'litecoin' | 'litecoinTest' | 'zcash' | 'zcashTest';
...
export declare const networks: Record<NetworkName, Network> & Record<'zcash' | 'zcashTest', ZcashNetwork>;
/**
