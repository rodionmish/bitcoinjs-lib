...
exports.createOutputScript2of3 = exports.createOutputScriptP2shP2pk = exports.scriptType2Of3AsPrevOutType = exports.isSupportedScriptType = exports.isScriptType2Of3 = exports.scriptTypes2Of3 = exports.scriptTypeP2shP2pk = void 0;
 ...
 */
function isSupportedScriptType(_network, scriptType) {
  switch (scriptType) {
    case 'p2sh':
    case 'p2shP2pk':
      return true;
...
function createOutputScriptP2shP2pk(pubkey) {
  const p2pk = __1.payments.p2pk({ pubkey });
  const p2sh = __1.payments.p2sh({ redeem: p2pk });
...
function createOutputScript2of3(pubkeys, scriptType, network) {
  ...
  // }
  const script2of3 = __1.payments.p2ms({ m: 2, pubkeys });
  ...
  switch (scriptType) {
    case 'p2sh':
      ...
      scriptPubKey = __1.payments.p2sh({ redeem: script2of3 });
      break;
    case 'p2shP2wsh':
      witnessScript = script2of3;
      redeemScript = __1.payments.p2wsh({ redeem: script2of3 });
      scriptPubKey = __1.payments.p2sh({ redeem: redeemScript });
      break;
    case 'p2wsh':
      witnessScript = script2of3;
      scriptPubKey = __1.payments.p2wsh({ redeem: witnessScript });
      break;
    default:
...
//   ];
// }
// export function createPaymentP2tr(pubkeys: Triple<Buffer>, redeemIndex?: number): Payment {
