...
(function(SCRIPT_TYPES) {
  SCRIPT_TYPES['P2MS'] = 'multisig';
  SCRIPT_TYPES['NONSTANDARD'] = 'nonstandard';
  SCRIPT_TYPES['NULLDATA'] = 'nulldata';
  SCRIPT_TYPES['P2PK'] = 'pubkey';
  SCRIPT_TYPES['P2PKH'] = 'pubkeyhash';
  SCRIPT_TYPES['P2SH'] = 'scripthash';
  SCRIPT_TYPES['P2WPKH'] = 'witnesspubkeyhash';
  SCRIPT_TYPES['P2WSH'] = 'witnessscripthash';
  SCRIPT_TYPES['WITNESS_COMMITMENT'] = 'witnesscommitment';
...
function fixMultisigOrder(input, transaction, vin) {
  ...
  input.signatures = input.pubkeys.map(pubKey => {
    const keyPair = ecpair_1.ECPair.fromPublicKey(pubKey);
    let match;
