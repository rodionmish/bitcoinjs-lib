...
import { Transaction, crypto } from '../..';
...
import { isMainnet, ZcashNetwork } from '../networks';
...
export function getDefaultConsensusBranchIdForVersion(
